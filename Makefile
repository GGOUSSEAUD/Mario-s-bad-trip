...
CFLAGS = -Wall -O3
LDFLAGS = -lm $(SDL_LDFLAGS) -lSDL2_image -lSDL2_mixer
...
EXTRAFILES = COPYING shaders/basic.vs shaders/basic.fs shaders/basic2.vs shaders/basic2.fs shaders/rotate.vs %.png
